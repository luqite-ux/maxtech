...
export function QualityPreview() {
  return (
    <div className="grid items-center gap-8 rounded-md border border-graphite/10 bg-white p-6 shadow-soft lg:grid-cols-[.8fr_1.2fr] lg:p-8">
      <Image src="/images/certificates/iso-9001-enhanced.jpg" alt="ISO 9001 certificate" width={520} height={760} className="max-h-[520px] w-full rounded-md object-cover object-top" />
      <div>
