  ...
  return (
    <footer className="border-t border-graphite/10 bg-white">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1.2fr_.8fr_.8fr] lg:px-8">
        <div>
          <Link href="/" aria-label="MAXTECH home" className="inline-flex">
            <Image src="/images/brand/maxtech-logo.png" alt="MAXTECH" width={220} height={52} className="h-12 w-auto max-w-[220px] object-contain sm:h-14" />
          </Link>
      ...
      <div className="border-t border-graphite/10 px-4 py-5 text-center text-xs text-steel">
        © {new Date().getFullYear()} {siteInfo.company}. All rights reserved.
      </div>
    </footer>
  )
}
